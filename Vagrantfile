...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "rnorthover-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/northover"
  #   chef.validation_client_name = "northover-validator"
  #   chef.validation_key_path = ".chef/northover-validator.pem"
  # end
end
